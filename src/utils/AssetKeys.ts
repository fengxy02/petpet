...
export const AssetManifest: AssetManifestItem[] = [
  ...
  { key: AssetKeys.UI.IconLetter, path: assetPath("assets/animal-island-ui/icons/icon-chat.svg"), kind: "ui", width: 48, height: 48 },
  { key: AssetKeys.UI.IconCollection, path: assetPath("assets/animal-island-ui/icons/icon-critterpedia.svg"), kind: "ui", width: 48, height: 48 },
  { key: AssetKeys.UI.IconWardrobe, path: assetPath("assets/animal-island-ui/icons/icon-shopping.svg"), kind: "ui", width: 48, height: 48 },
  { key: AssetKeys.UI.IconSettings, path: assetPath("assets/animal-island-ui/icons/icon-map.svg"), kind: "ui", width: 48, height: 48 },
  { key: AssetKeys.UI.IconArrange, path: assetPath("assets/animal-island-ui/icons/icon-diy.svg"), kind: "ui", width: 48, height: 48 },
  { key: AssetKeys.UI.IconMap, path: assetPath("assets/animal-island-ui/icons/icon-map.svg"), kind: "ui", width: 48, height: 48 },
  { key: AssetKeys.UI.IconShopping, path: assetPath("assets/animal-island-ui/icons/icon-shopping.svg"), kind: "ui", width: 48, height: 48 },
  { key: AssetKeys.UI.IconDiy, path: assetPath("assets/animal-island-ui/icons/icon-diy.svg"), kind: "ui", width: 48, height: 48 },
